...
TracingCache::TracingCache(uint32_t _numLines, CC* _cc, CacheArray* _array, ReplPolicy* _rp, uint32_t _accLat, uint32_t _invLat, uint32_t _accFastLat, g_string& _tracefile, g_string& _name) :
    Cache(_numLines, _cc, _array, _rp, _accLat, _invLat, _accFastLat, _name), tracefile(_tracefile)
{
