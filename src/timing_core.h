...
class TimingCore : public Core {
    ...
    private:
        ...
        static void PredLoadAndRecordFunc(THREADID tid, ADDRINT addr, UINT32 size, BOOL pred);
        static void PredStoreAndRecordFunc(THREADID tid, ADDRINT addr, UINT32 size, BOOL pred);
